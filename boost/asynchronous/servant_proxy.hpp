...
#define BOOST_ASYNC_POST_MEMBER(...)                                                                            \
    BOOST_PP_EXPAND(BOOST_PP_OVERLOAD(BOOST_ASYNC_POST_MEMBER_,__VA_ARGS__)(__VA_ARGS__))
...
#define BOOST_ASYNC_POST_MEMBER_LOG(...)                                                                        \
    BOOST_PP_EXPAND(BOOST_PP_OVERLOAD(BOOST_ASYNC_POST_MEMBER_LOG_,__VA_ARGS__)(__VA_ARGS__))
...
#define BOOST_ASYNC_FUTURE_MEMBER_LOG(...)                                                                      \
    BOOST_PP_EXPAND(BOOST_PP_OVERLOAD(BOOST_ASYNC_FUTURE_MEMBER_LOG_,__VA_ARGS__)(__VA_ARGS__))
...
#define BOOST_ASYNC_FUTURE_MEMBER(...)                                                                          \
    BOOST_PP_EXPAND(BOOST_PP_OVERLOAD(BOOST_ASYNC_FUTURE_MEMBER_,__VA_ARGS__)(__VA_ARGS__))
...
#define BOOST_ASYNC_MEMBER_UNSAFE_CALLBACK(...)                                                                          \
    BOOST_PP_EXPAND(BOOST_PP_OVERLOAD(BOOST_ASYNC_MEMBER_UNSAFE_CALLBACK_,__VA_ARGS__)(__VA_ARGS__))
...
#define BOOST_ASYNC_MEMBER_UNSAFE_CALLBACK_LOG(...)                                                                          \
    BOOST_PP_EXPAND(BOOST_PP_OVERLOAD(BOOST_ASYNC_MEMBER_UNSAFE_CALLBACK_LOG_,__VA_ARGS__)(__VA_ARGS__))
...
#define BOOST_ASYNC_POST_CALLBACK_MEMBER(...)                                                                                                       \
    BOOST_PP_EXPAND(BOOST_PP_OVERLOAD(BOOST_ASYNC_POST_CALLBACK_MEMBER_,__VA_ARGS__)(__VA_ARGS__)    
...
#define BOOST_ASYNC_SERVANT_POST_CTOR(...)                                                                      \
    BOOST_PP_EXPAND(BOOST_PP_OVERLOAD(BOOST_ASYNC_SERVANT_POST_CTOR_,__VA_ARGS__)(__VA_ARGS__))
...
#define BOOST_ASYNC_SERVANT_POST_CTOR_LOG(...)                                                                  \
    BOOST_PP_EXPAND(BOOST_PP_OVERLOAD(BOOST_ASYNC_SERVANT_POST_CTOR_LOG_,__VA_ARGS__)(__VA_ARGS__))
...
#define BOOST_ASYNC_SERVANT_POST_DTOR(...)                                                                      \
    BOOST_PP_EXPAND(BOOST_PP_OVERLOAD(BOOST_ASYNC_SERVANT_POST_DTOR_,__VA_ARGS__)(__VA_ARGS__))
...
#define BOOST_ASYNC_SERVANT_POST_DTOR_LOG(...)                                                                  \
    BOOST_PP_EXPAND(BOOST_PP_OVERLOAD(BOOST_ASYNC_SERVANT_POST_DTOR_LOG_,__VA_ARGS__)(__VA_ARGS__))
